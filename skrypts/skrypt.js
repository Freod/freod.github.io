	...
	*/
	function tworzenie(ilosc_akapitow){
		for(i=0; i<ilosc_akapitow; i++){
			...
			/*tab*/
			document.getElementById("paragraph").innerHTML += ('<div><a class="extend_img" href="" title="Powieksz"><div class="col-lg-3 col-md-4 col-12 float-left"><img class="miniature" alt="Obraz niedziała" src=""></a></div><div class="col-lg-9 col-md-8 col-12 d-flex float-right information"></div></div>');
			//document.getElementsByClassName("modal")[0].innerHTML += ('<div class="mySlides"><img class="img_powieksz" src="" style="width:100%"></div>');
		}
	}
	//Wyswietlanie
	function wyswietlanie(tab, ilosc_akapitow){
		for(j=0; j<ilosc_akapitow; j++){
			...
			document.getElementsByClassName("information")[j].innerHTML += '<div class="col-lg-2 float-right float-down"><a class="read_more" href="">Czytaj wiecej...</a></div>';
