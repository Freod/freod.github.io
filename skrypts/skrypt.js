	...
	*/
	function tworzenie(ilosc_akapitow){
		for(i=0; i<ilosc_akapitow; i++){
			...
			/*tab*/
			document.getElementById("paragraph").innerHTML += ('<div><a class="extend_img" href="" title="Powieksz"><div class="col-md-4"><img class="miniature" alt="Obraz niedziała" src=""></a></div><div class="col-md-8 d-block float-right information"></div></div>');
			//document.getElementsByClassName("modal")[0].innerHTML += ('<div class="mySlides"><img class="img_powieksz" src="" style="width:100%"></div>');
		}
	}
	//Wyswietlanie
