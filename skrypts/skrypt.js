	...
	*/
	function tworzenie(ilosc_akapitow){
		for(i=0; i<ilosc_akapitow; i++){
			...
			/*tab*/
			document.getElementById("paragraph").innerHTML += ('<div class="container pudelko"><div class="container information"><a class="extend_img" href="" title="Powieksz"><img class="miniature" alt="Obraz niedziała" src=""></a></div></div>');
			//document.getElementsByClassName("modal")[0].innerHTML += ('<div class="mySlides"><img class="img_powieksz" src="" style="width:100%"></div>');
		}
	}
	//Wyswietlanie
	function wyswietlanie(tab, ilosc_akapitow){
		for(j=0; j<ilosc_akapitow; j++){
			...
			document.getElementsByClassName("information")[j].innerHTML += '<a class="read_more float-right" href="">Czytaj wiecej...</a>';
