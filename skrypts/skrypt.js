	...
	*/
	function tworzenie(ilosc_akapitow){
		for(i=0; i<ilosc_akapitow; i++){
			...
			/*tab*/
			document.getElementById("paragraph").innerHTML += ('<a class="extend_img" href="" title="Powieksz"><img class="miniature" alt="Obraz niedziała" src=""></a><span class="d-block information"></span>');
			//document.getElementsByClassName("modal")[0].innerHTML += ('<div class="mySlides"><img class="img_powieksz" src="" style="width:100%"></div>');
		}
	}
	//Wyswietlanie
